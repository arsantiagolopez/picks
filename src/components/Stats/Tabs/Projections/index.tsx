...
const Projections: FC<Props> = ({
  ...
  return (
    <div className="h-full min-h-[50vh]">
      <h1 className="font-Basic text-4xl md:text-5xl font-bold tracking-tight">
      ...
      <div className="flex flex-col">
        <div className="flex flex-col items-start md:flex-row flex-wrap md:items-center">
          <p className="font-Basic text-3xl font-bold tracking-tight mr-3">
            $
            {Number(inputValue) === 0
              ? "0"
          ...
          <p className="font-Basic text-3xl font-bold tracking-tight">
            ${returns}
          </p>
        </div>
        ...
        <div className="flex flex-row justify-start items-center pt-8 md:pt-10">
          <p className="font-Basic text-5xl font-bold tracking-tight">
            {emojiText}
          </p>
        </div>
      </div>
